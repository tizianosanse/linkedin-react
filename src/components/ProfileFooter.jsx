      ...
      <div className="d-flex justify-content-center flex-column align-items-center">
        <div className="footerProfilePage">
          <Row>
            ...
            <Col xs={12} md={3}>
              <div className="d-flex flex-direction-column my-1 ">
                ...
                <div className="lineHeightFooter">
                  <p className="p-0 m-0 fw-bold textColorGray hoverblue">
                    Domande?
                  </p>
                  <span className="textColorLightGrey fontPiccoloFooter">
            ...
            <Col xs={12} md={3}>
              <p className="p-0 m-0 fontPiccoloFooter">
                Seleziona lingua
              </p>
              <Dropdown
                className="dropdownLingueFooter borderSolidFooter"
                drop="up"
              >
