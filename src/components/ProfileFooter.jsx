            ...
            <Col xs={12} md={3}>
              <div className="d-flex flex-direction-column my-1 ">
                ...
                <div className="lineHeightFooter">
                  <p className="p-0 m-0 fw-bold textColorGray hoverblue">Domande?</p>
              ...
              <div className="d-flex my-3 ">
                ...
                <div className="lineHeightFooter">
                  <p className="p-0 m-0 fw-bold textColorGray hoverblue">Gestisci il tuo account e la tua privacy</p>
              ...
              <div className="d-flex my-3 ">
                ...
                <div className="lineHeightFooter">
                  <p className="p-0 m-0 fw-bold textColorGray hoverblue">Trasparenza sui contenuti consigliati</p>
