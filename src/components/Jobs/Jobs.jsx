          ...
          <Col xs={2} md={2} lg={2}>
            <div className="bg-white rounded-4 p-4">
              <Row>
                ...
                <Col xs={10}>
                  <h2 className="fs-5">Le mie offerte di lavoro</h2>
                </Col>
              </Row>
              <Row>
                <Col xs={1}>
                ...
                <Col xs={11}>
                  <h2 className="fs-5">Preferenze</h2>
                </Col>
              </Row>
              <Row>
                <Col xs={1}>
                ...
                <Col xs={11}>
                  <h2 className="fs-5">Valutazioni delle competenze</h2>
                </Col>
              </Row>
              <Row>
                <Col xs={1}>
                ...
                <Col xs={11}>
                  <h2 className="fs-5">Indicazioni per chi cerca lavoro</h2>
                </Col>
              </Row>
            </div>
          </Col>
