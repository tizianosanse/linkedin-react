...
import { Button, Col, Container, Dropdown, Form, Image, Modal, Nav, NavDropdown, Navbar, Row } from "react-bootstrap";
    ...
    <>
      <Navbar className="bg-white p-0 navbarContainer d-flex flex-column">
        <Container fluid className=" justify-content-evenly">
          ...
          {showInputSearch === false && (
            <Nav className=" my-2 my-lg-0 align-items-center" style={{ maxHeight: "100px" }} navbarScroll>
              <div className="divIconsNavbar">
                <NavLink className="p-0  d-flex nav-link flex-column align-items-center" to={"/"}>
                  <p className="m-0">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
              ...
              <div className="divIconsNavbar">
                <NavLink className="p-0 d-flex nav-link flex-column align-items-center" to={"/rete"}>
                  <p className="m-0">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
              ...
              <div className="divIconsNavbar">
                <NavLink className="p-0 d-flex nav-link flex-column align-items-center" to={"/jobs"}>
                  <p className="m-0">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
              ...
              <div className="divIconsNavbar">
                <NavLink className="p-0 d-flex flex-column align-items-center nav-link" to={"/Messaggistica"}>
                  <p className="m-0">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
              ...
              <div className="divIconsNavbar">
                <NavLink className="p-0 d-flex flex-column align-items-center nav-link" to={"/notifiche"}>
                  <p className="m-0">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
              ...
              <p className="m-0 mx-3 d-inline d-lg-none">
                <i className="bi bi-three-dots"></i>
              </p>
              <div className="d-flex flex-column align-items-center justify-content-center">
                <NavDropdown
                  title={
                    <Button variant="btn" className="d-flex flex-column align-items-center">
                      <Image
                        src={
                          information
                            ? information.image
      ...
      <div style={{ width: "100%" }} className={"subNavbar d-none d-xl-block  subNavShow "}>
        <Col xs={12} className="d-flex justify-content-center my-2" style={{ width: "85%", marginInline: "auto" }}>
          <Dropdown>
            <Dropdown.Toggle variant="success" id="dropdown-basic" className="rounded-pill py-1">
              Lavoro
            </Dropdown.Toggle>

            <Dropdown.Menu>
              <Dropdown.Item href="#/action-1">Tutto</Dropdown.Item>
              <Dropdown.Item href="#/action-2">Persone</Dropdown.Item>
              <Dropdown.Item href="#/action-3">Aziende</Dropdown.Item>
              <Dropdown.Item href="#/action-4">Corsi</Dropdown.Item>
              <Dropdown.Item href="#/action-5">Scuole e Università</Dropdown.Item>
              <Dropdown.Item href="#/action-6">Post</Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
          <div className="border-end border-start">
            <Button variant="outline-dark" className="rounded-pill py-1 fw-bold ms-2">
              Data di pubblicazione
            </Button>
            <Button variant="outline-dark" className="rounded-pill py-1 fw-bold">
          ...
          <div className="d-flex align-items-center">
            <Button variant="outline-dark" className="fw-semibold rounded-pill btn-altro py-1 fw-bold ms-2">
              Altro
            </Button>
          </div>
        </Col>
