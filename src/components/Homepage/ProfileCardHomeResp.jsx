...
const ProfileCardHomeResp = () => {
  ...
  return (
    <>
      <Card className="d-block d-md-none my-3">
        <Card.Img
          ...
          <div id="example-collapse-text">
            <div>
              <div className="divVisitatoriImpressioni p-2 pb-1">
                <p
                  className="m-0 textColorLightGrey fw-bold"
                  style={{ fontSize: "12px" }}
                >
            ...
            <div className="p-2 underlineGray">
              <p className="textColorLightGrey m-0">
                Fai crescere il tuo buisness con Premium
              </p>
      ...
      <Collapse in={open}>
        <div id="example-collapse-text">
          ...
          >
            <div
              className="p-2 underlineGray"
              style={{
                fontSize: "12px",
                position: "relative",
              }}
            >
              <Link className="d-block textBlueLight mb-2">
                Gruppi
              </Link>
              <Link className="d-block textBlueLight mb-2">
                Eventi
              </Link>
              <Link className="d-block textBlueLight mb-1">
                Salvati
              </Link>
              <p
                style={{
