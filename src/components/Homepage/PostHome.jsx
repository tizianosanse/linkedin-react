      ...
      >
        <div className="d-flex align-items-center">
          ...
          <div className="mx-2">
            ...
            <p className="m-0 fontSizeDodici">
              {getYearAndMonth(props.post.createdAt)}
            </p>
          </div>
        </div>
        ...
        <Card.Footer className="mt-3 bg-white">
          <div className="d-flex justify-content-between">
            ...
            >
              ...
              <p className="m-0 textP fw-bold postActionsColor d-none d-md-inline">
                {" "}
                Consiglia
              </p>
            </Button>
              ...
              <Collapse>
                ...
                >
                  <div className="congratulationsPost d-flex justify-content-between mt-3">
                    ...
                    <Button className="rounded-circle d-none d-sm-block">
                      👍
                    </Button>
                    <Button className="rounded-pill d-none d-md-block">
                      Ottimo!
                    </Button>
                  </div>
                  ...
                  >
                    <Image
                      ...
                      width={35}
                      height={35}
                      className="imageUserNavbar mx-2"
                    ></Image>
                    <Form.Control
                      style={{
                        width: "70%",
                    ...
                    >
                      ...
                      <div className="divCommentsText">
                        ...
                        <p className="textP2 fw-bold">
                          Voto:{" "}
                          <span className="fw-bold spanRatePost">
                            {comment.rate}
                          </span>
                        </p>
