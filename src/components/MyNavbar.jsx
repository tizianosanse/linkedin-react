...
const MyNavbar = () => {
  ...
  const handleCheangeProfile = (value) => {
    setQueryUser(value);
  };
  const handleSubmitProfile = (e) => {
    ...
    const profile = profiles.find(
      (profile) =>
        profile.name !== "" &&
        profile.surname !== "" &&
        queryUser.toLocaleLowerCase().includes(profile.name.toLowerCase()) &&
        queryUser.toLocaleLowerCase().includes(profile.surname.toLowerCase())
    );
    if (profile) {
      navigate("/profilePage/" + profile._id);
    }
    console.log("handlesubmitprofile", profile);
        ...
        <Container fluid className=" justify-content-evenly">
          <div className="d-flex align-items-center">
            ...
            {location.pathname.includes("/jobs") ? (
              <Form
                className="d-flex position-relative d-none d-md-block"
                onSubmit={(e) => {
                  handleSubmitJob(e);
                }}
              >
              ...
              >
                <Form.Control
                  ...
                  aria-label="Search"
                  value={queryUser}
                  onChange={(e) => handleCheangeProfile(e.target.value)}
                />
            ...
            <Nav className=" my-2 my-lg-0 align-items-center" style={{ maxHeight: "100px" }} navbarScroll>
              <div className="divIconsNavbar">
                <NavLink className="p-0  d-flex nav-link flex-column align-items-center" to={"/"}>
                  ...
                  <p className="m-0 d-none d-md-inline">Home</p>
                </NavLink>
              </div>
              <div className="divIconsNavbar">
                <NavLink className="p-0 d-flex nav-link flex-column align-items-center" to={"/rete"}>
                  ...
                  <p className="m-0 d-none d-md-inline">Rete</p>
                </NavLink>
              </div>
              <div className="divIconsNavbar">
                <NavLink className="p-0 d-flex nav-link flex-column align-items-center" to={"/jobs"}>
                  ...
                  <p className="m-0 d-none d-md-inline">Lavoro</p>
                </NavLink>
              </div>
              <div className="divIconsNavbar">
                <NavLink className="p-0 d-flex flex-column align-items-center nav-link" to={"/Messaggistica"}>
                  ...
                  <p className="m-0 d-none d-md-inline">Messaggistica</p>
                </NavLink>
              </div>
              <div className="divIconsNavbar">
                <NavLink className="p-0 d-flex flex-column align-items-center nav-link" to={"/notifiche"}>
                  ...
                  <p className="m-0 d-none d-md-inline">Notifiche</p>
                </NavLink>
              </div>
                  ...
                  title={
                    <Button variant="btn" className="d-flex flex-column align-items-center">
                      ...
                      <div className="d-flex align-items-center ms-2">
                        <span className="dropdown-text">Tu</span>
                ...
                <NavDropdown
                  title={
                    <Button variant="btn" className="d-flex flex-column align-items-center">
                      ...
                      <div className="d-flex align-items-center ms-2">
                        <span className="dropdown-text">Per le aziende</span>
                        <FaChevronDown className="custom-dropdown-icon" />
                      </div>
                    </Button>
                  }
