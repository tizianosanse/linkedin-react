...
const MyNavbar = () => {
  ...
  const handleSubmitProfile = (e) => {
    ...
    const profile = profiles.find(
      (profile) =>
        ...
        queryUser
          .toLocaleLowerCase()
          .includes(profile.surname.toLowerCase())
    );
    if (profile) {
  ...
  window.addEventListener("scroll", () => {
    if (
      window.scrollY > 600 &&
      location.pathname === "/profilePage/me"
    ) {
      setShowProva(true);
    } else {
      setShowProva(false);
            ...
            {location.pathname.includes("/jobs") ? (
              ...
              >
                <Form.Control
                  ...
                  value={queryUser}
                  onChange={(e) =>
                    handleCheangeProfile(e.target.value)
                  }
                />
          ...
          {showInputSearch === false && (
            ...
            >
              <div className="divIconsNavbar">
                <NavLink
                  className="p-0  d-flex nav-link flex-column align-items-center"
                  to={"/"}
                >
                  <p className="m-0">
                    <svg
              ...
              <div className="divIconsNavbar">
                <NavLink
                  className="p-0 d-flex flex-column align-items-center nav-link"
                  to={"/Messaggistica"}
                >
                  <p className="m-0">
                    <svg
              ...
              <div className="d-flex flex-column align-items-center justify-content-center">
                ...
                >
                  ...
                  <div className="dropdownNavButtonDiv">
                    <Link
                      className="btn btn-outline-primary dropdownNavButton"
                      to={"/profilePage/me"}
                    >
                      Visualizza profilo
                    </Link>
                  ...
                  <Row>
                    ...
                    <Col xs={6} className="scopriAltro">
                      ...
                      <NavDropdown.Item href="#">
                        ...
                        <span className="spanDropdownNavbar">
                      ...
                      <NavDropdown.Item href="#">
                        ...
                        <span className="spanDropdownNavbar">
                          Acquisisci clienti e fai crescere
                          la tua azienda
                        </span>
                      </NavDropdown.Item>
                      <NavDropdown.Item href="#">
        ...
        >
          ...
          <div className="d-flex align-items-center">
            <Button
              ...
              className="fw-semibold rounded-pill btn-altro "
            >
              Altro
            </Button>
            <Button
