          ...
          {showInputSearch === false && (
            <Nav className=" my-2 my-lg-0" style={{ maxHeight: "100px" }} navbarScroll>
              <div className="divIconsNavbar">
                <NavLink className="p-0 d-none d-lg-flex nav-link flex-column align-items-center" to={"/"}>
                  <p className="m-0">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
              ...
              <div className="divIconsNavbar">
                <NavLink className="p-0 d-none d-lg-flex nav-link flex-column align-items-center" to={"/rete"}>
                  <p className="m-0">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
              ...
              <div className="divIconsNavbar">
                <NavLink className="p-0 d-none d-lg-flex nav-link flex-column align-items-center" to={"/jobs"}>
                  <p className="m-0">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
              ...
              <div className="divIconsNavbar">
                <NavLink className="p-0 d-none d-lg-flex flex-column align-items-center nav-link" to={"/Messaggistica"}>
                  <p className="m-0">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
              ...
              <div className="divIconsNavbar">
                <NavLink className="p-0 d-none d-lg-flex flex-column align-items-center nav-link" to={"/notifiche"}>
                  <p className="m-0">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
