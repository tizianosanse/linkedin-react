        ...
        <Row>
          ...
          <Col xs={10} className="px-0 mx-0">
            ...
            <p className="mb-0 textP">
              sviluppatore front end e back end, full stack developersviluppatore front end e back end, full stack
              developer feb 2024 - ago 2024feb 2024 - ago 2024{" "}
            </p>
        ...
        <Row className="mt-4 px-0">
          ...
          <Col xs={10} className="px-0 mx-0">
            ...
            <p className="textP mb-0">
              Diploma di Specializzazione di 1° livello DS1 in scienze e tecnologie informatiche, Tecnologia/tecnico di
              ingegneria dell automazione Diploma di Specializzazione di 1° livello DS1 in scienze e tecnologie
              informatiche, Tecnologia/tecnico di ingegneria dell automazione set 2014 - lug 2018set 2014 - lug 2018
            </p>
            <div className="d-flex ">
              {" "}
              <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" width="20px" height="20px" viewBox="0 0 24 24">
